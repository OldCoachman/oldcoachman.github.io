...
},{}],"scripts/api_processing.js":[function(require,module,exports) {
"use strict";
...
function createBreedList(breedList) {
  document.getElementById("breed").innerHTML = "\n    <select onchange=\"loadByBreed(this.value)\">\n        <option>Choose a dog breed</option>\n        ".concat(Object.keys(breedList).map(function (breed) {
    return "<option>".concat(breed, "</option>");
  }).join(''), "\n    </select>\n    ");
}

function loadByBreed(_x) {
  return _loadByBreed.apply(this, arguments);
}
...
function createSlideshow(images) {
  ...
  if (images.length > 1) {
    document.getElementById('slideshow').innerHTML = "\n        <div class=\"slide\" style=\"background-image: url('".concat(images[0], "')\"></div>\n        <div class=\"slide\" style=\"background-image: url('").concat(images[1], "')\"></div>\n        ");
    currentPosition += 2;
  ...
  function nextSlide() {
    document.getElementById('slideshow').insertAdjacentHTML("beforeend", "<div class=\"slide\" style=\"background-image: url('".concat(images[currentPosition], "')\"></div>"));
...
console.log((0, _isUrl.default)("fdfgdfgfd"));
start();
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/api_processing.js"], null)
//# sourceMappingURL=/api_processing.0e75b281.js.map